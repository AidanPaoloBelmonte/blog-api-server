...
async function createMockContent() {
  ...
  const comments = [
    ...
    {
      content: "Woah, the professor told me about it too!",
    },
    {
      content: "Cicero? That's a funny name, right Pipotchi?",
      authorID: users[1].id,
    },
    {
      content: "Man, no wonder European languages are so hard!",
      authorID: users[2].id,
    },
    {
      content:
  ...
  const entries = [
    ...
    },
    {
      ...
      comments: {
        createMany: { data: [comments[3], comments[4]] },
      },
    },
  ];
